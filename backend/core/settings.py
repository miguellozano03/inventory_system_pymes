...
if render_host and render_host not in ALLOWED_HOSTS:
    ALLOWED_HOSTS.append(render_host) # pyright: ignore[reportArgumentType]
...
if ENVIRONMENT == "PROD":
    # Producción: base de datos externa (Supabase/Neon) vía DATABASE_URL
    DATABASES = {
        "default": env.db("DATABASE_URL"),
    }
else:
    # Desarrollo local: SQLite (ver AGENTS.md, no cambiar el default local)
    DATABASES = {
        'default': {
